...
from ..models.job import JobModel, JobCreate, JobUpdate
...
class JobDAO:
    ...
    def create(self, job_data: JobCreate) -> JobModel:
        ...
        try:
            ...
            raise Exception(f"Database error creating job: {e}")
    ...
    def get_by_id(self, job_id: UUID) -> Optional[JobModel]:
        ...
        try:
            ...
            raise Exception(f"Database error getting job: {e}")
    ...
    def get_all(self, limit: int = 100, offset: int = 0) -> List[JobModel]:
        ...
        try:
            ...
            raise Exception(f"Database error getting jobs: {e}")
    
    def update(self, job_id: UUID, job_data: JobUpdate) -> Optional[JobModel]:
        ...
        try:
            ...
            raise Exception(f"Database error updating job: {e}")
    ...
    def delete(self, job_id: UUID) -> bool:
        ...
        try:
            ...
            raise Exception(f"Database error deleting job: {e}")